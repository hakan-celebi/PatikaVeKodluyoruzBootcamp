    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<UpdateBookModel, Book>()
                ...
                .ForMember(dest => dest.Title, opt => opt.Condition(src => src.Title != default && src.Title?.Trim() != string.Empty))
            ...
            CreateMap<UpdateGenreModel, Genre>()
                .ForMember(dest => dest.Name, opt => opt.Condition(src => src.Name != default && src.Name!.Trim() != string.Empty));            
            ...
            CreateMap<UpdateAuthorModel, Author>()
                ...
                .ForMember(dest => dest.MiddleName, opt => 
                    { 
                        ...
                        opt.MapFrom(src => (src.MiddleName == string.Empty ? null : src.MiddleName)); 
                    })
